...
The computing cluster we have did not have the power to compute all single cell data from all patients; we therefore addressed the issue using downsizing of the samples in addition to combining single cells from several subjects into computationally derived composite subjects in a randomized fashion. This approach allows us to sustain the heterogeniety of the dataset and include more cells as we found the number of patients to be a major limiting factor computationally.
